...
parser.add_argument('--spectral_A_block_size', default=9, type=int)
parser.add_argument('--spatial_A_block_size', default=4, type=int)
...
parser.add_argument('--spectral_B_block_size', default=9, type=int)
parser.add_argument('--spatial_B_block_size', default=4, type=int)
...
parser.add_argument('--halfwidth', default=4, type=int)
# mcc loss
...
seeds = [1315,1341,1851,1554,1726,1748,1499,1707,1586,1724]
nDataSet = len(seeds)
    ...
    for ep in range(1, num_epoch + 1):
        ...
        if ep % num_epoch == 0:
            ...
            if acc1 >= best_test_acc:
                # torch.save(G, "checkpoints/pavia/G.pt")
                # torch.save(F1, "checkpoints/pavia/F1.pt")
                # torch.save(F2, "checkpoints/pavia/F2.pt")
                best_test_acc = acc1
