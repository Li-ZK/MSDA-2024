...
# mask settings
parser.add_argument('--A_mask_ratio', default=0.9, type=float)
...
parser.add_argument('--spectral_A_block_size', default=5, type=int)
parser.add_argument('--spatial_A_block_size', default=3, type=int)
parser.add_argument('--B_mask_ratio', default=0.9, type=float)
...
parser.add_argument('--spectral_B_block_size', default=5, type=int)
    ...
    for ep in range(1, num_epoch + 1):
        ...
        if ep % num_epoch == 0:
            ...
            if acc1 >= best_test_acc:
                # torch.save(G, "checkpoints/YRD_unMask/G.pt")
                # torch.save(F1, "checkpoints/YRD_unMask/F1.pt")
                # torch.save(F2, "checkpoints/YRD_unMask/F2.pt")
                best_test_acc = acc1
